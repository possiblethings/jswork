...
var collegeSelect =document.getElementById('collegeSelect');
 ...
 var maiorSelect=document.getElementById('maiorSelect');
 collegeSelect.onchange = function(){
     maiorSelect.options.length=0;
     createOption(maiorSelect,majorsArr[collegeSelect.value]);

     if(collegeSelect.value>=0){
        maiorSelect.onchange();
     }else{
        calssSelect.options.length=0;
     }
 };
var calssSelect =document.getElementById('calssSelect');
maiorSelect.onchange =function(){
    calssSelect.options.length=0;
    createOption(calssSelect,classesArr[collegeSelect.value][maiorSelect.value]);
};
